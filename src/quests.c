...
static const u8 sText_EmptyQuest[] = _("");
static const u8 sText_EndQuest[] = _("End");
...
// SubQuest Locations
static const u8 sText_TaprootTown[] = _("Taproot Town");
static const u8 sText_SpectreCity[] = _("Spectre City");
static const u8 sText_ResearchInstitute[] = _("Research Institute");
static const u8 sText_MtDraco[] = _("Mt. Draco");
...
static const struct SubQuest sSubQuests1[QUEST_HELPING_THE_PROFESSOR_SUB_COUNT] =
{
	sub_quest(
	      0,
	      gText_SubQuest1_Name1,
	      gText_SubQuest1_Desc1,
	      sText_ResearchInstitute,
...
static const struct SubQuest sSubQuests2[QUEST_A_SPOOKY_START_SUB_COUNT] =
{
	sub_quest(
	      3,
...
static const struct SideQuest sSideQuests[QUEST_COUNT] =
{
	side_quest(
	      ...
	      OBJECT,
	      sSubQuests1,
	      QUEST_HELPING_THE_PROFESSOR_SUB_COUNT
	),
	side_quest(
	      ...
	      OBJECT,
	      sSubQuests2,
	      QUEST_A_SPOOKY_START_SUB_COUNT
	),
	side_quest(
