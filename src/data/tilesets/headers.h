...
const struct Tileset gTileset_Springwood =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Springwood,
    .palettes = gTilesetPalettes_Springwood,
    .metatiles = gMetatiles_Springwood,
    .metatileAttributes = gMetatileAttributes_Springwood,
    .callback = NULL,
};

const struct Tileset gTileset_Indoors =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Indoors,
    .palettes = gTilesetPalettes_Indoors,
    .metatiles = gMetatiles_Indoors,
    .metatileAttributes = gMetatileAttributes_Indoors,
    .callback = NULL,
};
